...
├── caixin-reader-relogin-and-block-redirect.js   # LIVE merged userscript
├── archive/               # Pre-merge .bak (simple / relogin / block / …)
└── userscripts/           # (cleared — see archive/)
```
...
Install `caixin-reader-relogin-and-block-redirect.js` (merged Simple-Caixin + block redirect + auto re-login).

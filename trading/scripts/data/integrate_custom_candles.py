...
BASE_DATA_DIR = Path("/allah/blue/trading/freqtrade/data")
CONFIG_FILE = Path("/allah/blue/trading/freqtrade/config/backtest.json")
...
def main():
    ...
    if args.create_strategy:
        strategy_dir = Path('/allah/blue/trading/freqtrade/strategies')

// ==UserScript==
// @name         Stake Baccarat Pick Telegram Monitor
...
/*
 * Renamed live script (enabled in TM backup 2026-08-08).
 * pick-telegram-monitor — Telegram bridge for pick
 * Snapshot: archive/pick-telegram-monitor.js.bak
 * (Not merged with sibling baccarat scripts — socks → pick → play pipeline.)
 */
...
(function() {
     ...
     */
    /** Same order as play.js `Config.WALLET_VALUE_SELS` (multibaccarat 1.3.30+). */
    ...
    /** Mirrors play.js `getBalance()` selector (PP multibaccarat wallet). */

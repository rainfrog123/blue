...
# Add herosms to path (shared under /allah/blue/automation/)
sys.path.insert(0, "/allah/blue/Automation/herosms")
import herosms
...
CONFIG = {
    ...
    "prefixes_file": "/allah/blue/Automation/worker/hyas_prefixes.txt",

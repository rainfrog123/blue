...
#                  Hy2 from repo (Brutal via common/stacks/hysteria/defaults.yaml), netplan dhcp6
#
set -e
...
bash /allah/blue/infra/cloud/common/stacks/ss-rust/up.sh ali

print_step "Starting Hysteria2 from common (Brutal defaults + ali site.yaml)..."
sudo mkdir -p /allah/blue/infra/cloud/hosts/ali/hysteria/acme
bash /allah/blue/infra/cloud/common/stacks/hysteria/up.sh ali

print_success "Proxies up (ss-rust :12033, hy2 :443)"
print_info "Shared configs: infra/cloud/common/stacks/{ss-rust,hysteria}/"
print_info "Host site files: infra/cloud/hosts/ali/"
...
print_info "  • Hysteria2: :443 (common/stacks defaults + hosts/ali site.yaml)"

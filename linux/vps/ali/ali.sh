...
echo "PermitRootLogin yes" | sudo tee /etc/ssh/sshd_config.d/99-permit-root.conf
...
sudo ln -sf /allah/blue/linux/extra/bashrc /root/.bashrc

# Notify user of script completion
echo "Alibaba Cloud VPS setup completed successfully!"

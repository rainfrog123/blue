...
For reverse engineering, see [octo_reverse-engineering.md](octo_reverse-engineering.md).
...
```bash
cd /allah/blue/automation/octo/auto
...
- `/allah/blue/Automation/herosms/` — HeroSMS API wrapper
- `/allah/blue/Automation/worker/hyas_prefixes.txt` — Email prefixes
...
[octo_reverse-engineering.md](octo_reverse-engineering.md), [octo_bypasses.md](octo_bypasses.md), [octo_hid.md](octo_hid.md), [octo_ghidra_guides.md](octo_ghidra_guides.md)

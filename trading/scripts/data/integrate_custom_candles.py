...
BASE_DATA_DIR = Path("/allah/blue/trading/user_data/data")
CONFIG_FILE = Path("/allah/blue/trading/user_data/config/backtest.json")
...
def main():
    ...
    if args.create_strategy:
        strategy_dir = Path('/allah/blue/trading/user_data/strategies')

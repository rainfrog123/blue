...
class TemaReversalLong(IStrategy):
    """
    ML Labeling Strategy: TEMA Reversal (Long-Only)

    Triple Barrier Method for binary classification:
    - Upper barrier: TP hit = Label 1 (Success)
    - Lower barrier: SL hit = Label 0 (Failure)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Risk and TP/SL levels (long-only)

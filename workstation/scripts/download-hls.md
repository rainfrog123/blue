...
```
workstation/scripts/download_hls.py   # this repo
workstation/scripts/download-hls.md
/media/videos/                        # local output (not in git)
```
...
python3 workstation/scripts/download_hls.py "PAGE_URL"

# Example
python3 workstation/scripts/download_hls.py "https://www.mrds66.com/archives/170930/"
```
...
python3 workstation/scripts/download_hls.py "https://www.mrds66.com/archives/171859/"

# Custom output name
python3 workstation/scripts/download_hls.py "https://www.mrds66.com/archives/171859/" my_video
```

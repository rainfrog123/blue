// ==UserScript==
// @name         Caixin Reader (Relogin + Block Redirect)
// @name:en      Caixin Reader (Relogin + Block Redirect)
// @namespace    http://www.caixin.com/
// @version      2.0.1
// @description  Simple reading UI + block Chinese locale redirect + auto re-login on kick
// @description:en Simple-Caixin cleanup, block caixinglobal redirect, auto re-login
// @author       You
// @match        *://*.caixin.com/*
 ...
 *   - archive/block_redirect.js.bak
 *       Block Caixin Global Redirect — spoof zh-CN navigator so site stays on caixin.com.
 *   - archive/simple_caixin.js.bak  (@name: Simple-Caixin / jijian caixin)
 *       Clean reading UI (hide chrome, enable copy/context menu, layout tweaks).
 *   - archive/auto_relogin.js.bak  (@name: Caixin Auto Relogin)
 *       Detect session kick and auto re-login via gateway.caixin.com.
 *
 * Also unused in TM (not installed / not in backup):
 *   - archive/copy.js.bak
 *   - archive/caixin-en-filter.user.js.bak
 */

(function () {
  "use strict";
  console.log("[Caixin Merged] loaded — block redirect + simple reader + auto relogin");
})();

// ========== Inherited: archive/block_redirect.js.bak ==========
(function () {
    'use strict';
...
// ========== Inherited: archive/simple_caixin.js.bak ==========
(function () {
    'use strict';
...
// ========== Inherited: archive/auto_relogin.js.bak ==========
(function () {
    'use strict';
